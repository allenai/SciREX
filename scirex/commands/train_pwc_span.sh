...
export CONFIG_FILE=scirex/training_config/pwc_config.jsonnet
...
export OUTPUT_BASE_PATH=${OUTPUT_DIR:-outputs/pwc_outputs/experiment_scirex_span/$1}

allennlp train -s $OUTPUT_BASE_PATH --include-package scirex $CONFIG_FILE