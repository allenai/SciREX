...
export CONFIG_FILE=scirex/training_config/pwc_config_crf_n_ary.jsonnet
...
export OUTPUT_BASE_PATH=${OUTPUT_DIR:-outputs/pwc_outputs/experiment_scirex_crf_n_ary/$1}

python -m allennlp.run evaluate --output-file $OUTPUT_BASE_PATH/metrics_test.json --include-package scirex \
