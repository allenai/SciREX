...
export CONFIG_FILE=dygie_pwc/training_config/bert_entity_linking_bert.jsonnet
...
python -m allennlp.run train -s $OUTPUT_BASE_PATH --include-package dygie_pwc --force $CONFIG_FILE